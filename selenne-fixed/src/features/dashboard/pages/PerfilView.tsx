...
import { User, Mail, Phone, MapPin, Edit, Loader2, X, Shield, Lock, Bell, FileText, Eye, EyeOff, ChevronDown, ChevronRight, IdCard } from 'lucide-react';
    ...
    <div className="p-8 bg-[#FBF8F5] dark:bg-[#2a2029] min-h-screen">
      ...
      <Dialog open={editModalOpen} onOpenChange={setEditModalOpen}>
        <DialogContent className="max-w-2xl h-auto flex flex-col p-0 gap-0">
          <DialogHeader className="px-5 sm:px-8 pt-5 sm:pt-6 pb-3 sm:pb-4 border-b border-[#E7E0DA] dark:border-[#453840] flex-shrink-0">
            <DialogTitle style={{ fontFamily: '"Playfair Display", Georgia, "Iowan Old Style", "Palatino Linotype", "Times New Roman", serif' }} className="text-xl sm:text-2xl">
              Editar Perfil
            </DialogTitle>
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="space-y-4 sm:space-y-6 py-4 sm:py-6 px-5 sm:px-8">
              ...
              <div className="bg-white dark:bg-[#322631] rounded-xl border border-[#E7E0DA] dark:border-[#453840] shadow-sm overflow-hidden">
                <div className="bg-[#FBF8F5] dark:bg-[#2a2029] px-5 sm:px-6 py-3 sm:py-4 border-b border-[#E7E0DA] dark:border-[#453840]">
                  <h3 style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="font-semibold text-[#241B22] dark:text-[#F5EDE9] text-base">Datos de Cuenta</h3>
                </div>
                <div className="p-5 sm:p-6 flex flex-col gap-4 sm:gap-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                    <div>
                      <label className="text-xs text-gray-600 dark:text-[#b8a3ac] block mb-1.5" style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
                        Documento <span className="text-[#A3395C]">*</span>
                      </label>
                      <div className="relative">
              ...
              <div className="bg-white dark:bg-[#322631] rounded-xl border border-[#E7E0DA] dark:border-[#453840] shadow-sm overflow-hidden">
                <div className="bg-[#FBF8F5] dark:bg-[#2a2029] px-5 sm:px-6 py-3 sm:py-4 border-b border-[#E7E0DA] dark:border-[#453840]">
                  <h3 style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="font-semibold text-[#241B22] dark:text-[#F5EDE9] text-base">Ubicación</h3>
                </div>
                <div className="p-5 sm:p-6 flex flex-col gap-4 sm:gap-5">
                  <div>
          ...
          <DialogFooter className="gap-2 px-5 sm:px-8 py-3 sm:py-5 border-t border-[#E7E0DA] dark:border-[#453840] flex-shrink-0">
