            ...
            {filtered.map(item => (
              <tr key={item.id} className="hover:bg-[#EFD9DF] dark:hover:bg-[#3a2530] transition">
                <td className="px-6 py-4">
                  <div className="w-8 h-8 rounded-full border-2 border-[#E7E0DA] dark:border-[#3a2e35] shadow-sm"
                ...
                <div className="p-6 flex flex-col gap-5">
                  <div className="flex flex-col gap-2">
                    ...
                    <Input value={formName} onChange={e => setFormName(e.target.value)}
                      placeholder="Ej: Rosa, Azul, Negro..." className="h-10 border-gray-300 dark:border-[#3a2e35]" />
                  </div>
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-4">
                      <input type="color" value={hexColor} onChange={e => setHexColor(e.target.value)}
                        className="w-16 h-10 border border-gray-300 dark:border-[#3a2e35] rounded-lg cursor-pointer" />
                      <div className="w-10 h-10 rounded-full border-2 border-[#E7E0DA] dark:border-[#3a2e35] shadow-sm" style={{ backgroundColor: hexColor }} />
