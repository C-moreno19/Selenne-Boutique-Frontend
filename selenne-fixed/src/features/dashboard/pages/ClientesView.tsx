  ...
  return (
    <div className="p-8 bg-[#FBF8F5] dark:bg-[#2a2029] min-h-screen">
      <div className="flex items-center gap-2 mb-4">
        ...
        <span style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-sm font-medium text-[#241B22] dark:text-[#F5EDE9]">Clientes</span>
      </div>

      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="admin-page-title text-4xl text-[#241B22] dark:text-[#F5EDE9]">Clientes</h1>
                  ...
                  <tr key={c.usuarioID} className="hover:bg-[#FBF8F5]/70 dark:hover:bg-[#362b34]/70 transition">
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="font-medium text-[#241B22] dark:text-[#F5EDE9] text-sm">{c.nombreCompleto}</p>
                          <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-xs text-gray-400 dark:text-[#b8a3ac]">{formatFecha(c.fechaRegistro)}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-5 py-4">
                      <span style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-sm text-gray-600 dark:text-[#b8a3ac]">{c.email}</span>
                    </td>
                    <td className="px-5 py-4">
                      <span style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-sm text-gray-600 dark:text-[#b8a3ac]">{c.telefono || '—'}</span>
                    </td>
                    <td className="px-5 py-4">
                      <span className={`inline-flex px-3 py-1 rounded-full text-xs font-semibold ${c.estado === 'activo' ? 'bg-green-100 dark:bg-green-950/40 text-green-700 dark:text-green-400' : 'bg-red-100 dark:bg-red-950/40 text-red-600 dark:text-red-400'}`}
                        style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
                    ...
                    <td className="px-5 py-4">
                      <button onClick={() => { setSelectedCliente(c); setViewOpen(true); }}
                        className="p-1.5 text-gray-400 dark:text-[#b8a3ac] hover:bg-blue-50 dark:hover:bg-blue-950/40 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg transition" title="Ver detalles">
                ...
                <div className="bg-white dark:bg-[#322631] rounded-xl border border-[#E7E0DA] dark:border-[#453840] shadow-sm overflow-hidden">
                  ...
                  <div className="p-6 grid grid-cols-2 gap-6">
                    <div className="flex flex-col gap-1">
                      <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-xs text-gray-500 dark:text-[#b8a3ac] uppercase font-medium">Nombre</p>
                      <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-sm font-semibold text-[#241B22] dark:text-[#F5EDE9]">{selectedCliente.nombreCompleto}</p>
                    </div>
                    <div className="flex flex-col gap-1">
                      <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-xs text-gray-500 dark:text-[#b8a3ac] uppercase font-medium">Teléfono</p>
                      <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-sm font-semibold text-[#241B22] dark:text-[#F5EDE9]">{selectedCliente.telefono || '—'}</p>
                    </div>
                    <div className="flex flex-col gap-1">
                      <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-xs text-gray-500 dark:text-[#b8a3ac] uppercase font-medium">Documento</p>
                      <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-sm font-semibold text-[#241B22] dark:text-[#F5EDE9]">{selectedCliente.documento || '—'}</p>
                    </div>
                    <div className="flex flex-col gap-1 col-span-2">
                      <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-xs text-gray-500 dark:text-[#b8a3ac] uppercase font-medium">Email</p>
                      <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-sm font-semibold text-[#241B22] dark:text-[#F5EDE9] break-all">{selectedCliente.email}</p>
                    </div>
                    <div className="flex flex-col gap-1 col-span-2">
                      <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-xs text-gray-500 dark:text-[#b8a3ac] uppercase font-medium">Dirección</p>
                      <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-sm font-semibold text-[#241B22] dark:text-[#F5EDE9]">{getDireccion(selectedCliente)}</p>
                    </div>
                    <div className="flex flex-col gap-1">
                      <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-xs text-gray-500 dark:text-[#b8a3ac] uppercase font-medium">Estado</p>
                      <span className={`inline-flex w-fit px-3 py-1 rounded-full text-xs font-semibold ${selectedCliente.estado === 'activo' ? 'bg-green-100 dark:bg-green-950/40 text-green-700 dark:text-green-400' : 'bg-red-100 dark:bg-red-950/40 text-red-600 dark:text-red-400'}`}>
                      ...
                      <div className="p-6 space-y-3 max-h-48 overflow-y-auto">
                        {pedidosCliente.map(pedido => (
                          <div key={pedido.id} className="flex justify-between items-center p-3 bg-[#FBF8F5] dark:bg-[#2a2029] rounded-xl">
                            ...
                            <div className="flex items-center gap-3">
                              <span style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-sm font-bold text-[#241B22] dark:text-[#F5EDE9]">{formatCurrency(pedido.monto ?? 0)}</span>
                              <span className={`px-2 py-1 rounded-lg text-xs font-semibold ${
                                pedido.estado === 'Completada' ? 'bg-green-100 dark:bg-green-950/40 text-green-700 dark:text-green-400' :
                                pedido.estado === 'Aprobada' ? 'bg-blue-100 dark:bg-blue-950/40 text-blue-700 dark:text-blue-400' :
                                pedido.estado === 'Pendiente' ? 'bg-yellow-100 dark:bg-yellow-950/40 text-yellow-700 dark:text-yellow-400' :
