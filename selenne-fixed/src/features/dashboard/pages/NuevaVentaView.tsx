  ...
  return (
    <div className="p-8 bg-[#FBF8F5] dark:bg-[#1c151a] min-h-screen">
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="admin-page-title text-[32px] text-[#241B22] dark:text-[#F5EDE9]">
            Nueva Venta
          </h1>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-[#241B22] rounded-xl p-6 shadow-sm border border-[#E7E0DA] dark:border-[#3a2e35]">
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="cliente" className="text-sm text-gray-700 dark:text-[#F5EDE9] block mb-2" style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
                  Cliente *
                </Label>
              ...
              <div>
                <Label htmlFor="metodoPago" className="text-sm text-gray-700 dark:text-[#F5EDE9] block mb-2" style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
                  Método de Pago
                </Label>
          ...
          <div className="bg-white dark:bg-[#241B22] rounded-xl p-6 shadow-sm border border-[#E7E0DA] dark:border-[#3a2e35]">
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="producto" className="text-sm text-gray-700 dark:text-[#F5EDE9] block mb-2" style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
                  Producto
                </Label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="cantidad" className="text-sm text-gray-700 dark:text-[#F5EDE9] block mb-2" style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
                    Cantidad
                  </Label>
                  <Input
                    type="number"
                ...
                {productosVenta.map((producto) => (
                  <div key={producto.id} className="flex items-center justify-between bg-[#FBF8F5] dark:bg-[#1c151a] p-4 rounded-lg border border-[#E7E0DA] dark:border-[#3a2e35]">
                    <div className="flex-1">
                      ...
                      <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-sm text-gray-600 dark:text-[#b8a3ac]">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-[#241B22] dark:text-[#F5EDE9] font-semibold w-20 text-right">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white dark:bg-[#241B22] rounded-xl p-6 shadow-sm border border-[#E7E0DA] dark:border-[#3a2e35] sticky top-24">
            ...
            <div className="mt-6 pt-6 border-t border-[#E7E0DA] dark:border-[#3a2e35]">
              ...
              <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-2xl text-[#241B22] dark:text-[#F5EDE9]">
                {productosVenta.length}
              </p>
              {productosVenta.length > 0 && (
                <p style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }} className="text-xs text-gray-500 dark:text-[#b8a3ac] mt-2">
